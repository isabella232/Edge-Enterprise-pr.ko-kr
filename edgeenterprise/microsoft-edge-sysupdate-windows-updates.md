...
> [!IMPORTANT]
> <span data-ttu-id="9c66a-105">Microsoft Edge 레거시 서비스 종료에 대한 Microsoft Edge [제품](https://aka.ms/EdgeLegacyEOS) 팀 블로그 게시물을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="9c66a-105">Refer to the Microsoft Edge product team [blog post](https://aka.ms/EdgeLegacyEOS) about Microsoft Edge Legacy end of service.</span></span>
...
<span data-ttu-id="9c66a-116">모든 업데이트가 적용되고 다음 버전 Microsoft Edge의 안정 채널이 시스템 수준에서 설치되면 다음 변경 사항이 시스템에 적용됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-116">When all the updates are applied AND the Stable channel of the next version of Microsoft Edge is installed at the system-level, the following changes will take effect on the system:</span></span>

- <span data-ttu-id="9c66a-117">현재 버전 Microsoft Edge의 모든 시작 메뉴 핀, 타일 및 바로 가기가 다음 버전 Microsoft Edge으로 마이그레이션됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-117">All start menu pins, tiles, and shortcuts for the current version of Microsoft Edge will migrate to the next version of Microsoft Edge.</span></span>
- <span data-ttu-id="9c66a-118">현재 버전 Microsoft Edge의 모든 작업 표시줄 핀 및 바로 가기가 다음 버전 Microsoft Edge으로 마이그레이션됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-118">All taskbar pins and shortcuts for the current version of Microsoft Edge will migrate to the next version of Microsoft Edge.</span></span>
- <span data-ttu-id="9c66a-119">다음 버전 Microsoft Edge는 작업 표시줄에 고정됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-119">The next version of Microsoft Edge will be pinned to the taskbar.</span></span> <span data-ttu-id="9c66a-120">현재 버전 Microsoft Edge이 이미 고정되어 있는 경우 대체됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-120">If the current version of Microsoft Edge is already pinned, it will be replaced.</span></span>
- <span data-ttu-id="9c66a-121">다음 버전 Microsoft Edge가 바탕 화면에 바로 가기를 추가합니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-121">The next version of Microsoft Edge will add a shortcut to the desktop.</span></span> <span data-ttu-id="9c66a-122">현재 버전 Microsoft Edge 바로 가기가 이미 있는 경우 대체됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-122">If the current version of Microsoft Edge already has a shortcut, it will be replaced.</span></span>
- <span data-ttu-id="9c66a-123">기본적으로 Microsoft Edge가 처리하는 대부분의 프로토콜이 다음 버전 Microsoft Edge으로 마이그레이션됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-123">Most protocols that Microsoft Edge handles by default will be migrated to the next version of Microsoft Edge.</span></span>
- <span data-ttu-id="9c66a-124">현재 버전 Microsoft Edge는 설정, 모든 앱 및 모든 파일 또는 프로토콜 지원 대화 상자를 포함하여 OS의 모든 UX 화면에서 숨겨집니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-124">Current Microsoft Edge will be hidden from all UX surfaces in the OS, including settings, all apps, and any file or protocol support dialogs.</span></span>
- <span data-ttu-id="9c66a-125">현재 버전 Microsoft Edge를 시작하려는 모든 시도는 다음 버전 Microsoft Edge로 리디렉션됩니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-125">All attempts to launch the current version of Microsoft Edge will redirect to the next version of Microsoft Edge.</span></span>

  > [!NOTE]
  > <span data-ttu-id="9c66a-126">사용자 수준 설치는 이러한 동작을 트리거하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-126">User-level installs won’t trigger these behaviors.</span></span>

<span data-ttu-id="9c66a-127">위 변경 내용과 함께 다음 버전 Microsoft Edge의 안정 채널이 설치되어 있는지 여부에 관계없이 발생하는 변경 사항이 있습니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-127">Along with the previous changes, there are changes that will happen regardless of whether the Stable channel of the next version of Microsoft Edge is installed.</span></span>
...
- <span data-ttu-id="9c66a-135">2019년 9월 보안 업데이트와 함께 제공되는 선택적 2019년 8월 업데이트의 두 번째 변경 내용 집합.</span><span class="sxs-lookup"><span data-stu-id="9c66a-135">Second set of changes in the optional August 2019 update, delivered with the September 2019 security update.</span></span>
  ...
  > [!NOTE]
  > <span data-ttu-id="9c66a-136">이 업데이트에서는 Microsoft Edge가 XML 프로토콜의 등록을 해제합니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-136">This is the update where Microsoft Edge will de-register for the XML protocol.</span></span>

- <span data-ttu-id="9c66a-137">2019년 10월 보안 업데이트와 함께 제공되는 선택적 2019년 9월 업데이트의 세 번째 변경 내용 집합.</span><span class="sxs-lookup"><span data-stu-id="9c66a-137">Third set of changes in the optional September 2019 update, delivered with the October 2019 security update.</span></span>
...
- <span data-ttu-id="9c66a-141">2019년 10월 보안 업데이트와 함께 제공되는 선택적 2019년 9월 업데이트의 두 번째 변경 내용 집합.</span><span class="sxs-lookup"><span data-stu-id="9c66a-141">Second set of changes in an optional September 2019 update, delivered with the October 2019 security update.</span></span>
  ...
  > [!NOTE]
  > <span data-ttu-id="9c66a-142">이 업데이트에서는 Microsoft Edge가 XML 프로토콜의 등록을 해제합니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-142">This is the update where Microsoft Edge will de-register for the XML protocol.</span></span>

- <span data-ttu-id="9c66a-143">2019년 11월 보안 업데이트와 함께 제공되는 선택적 2019년 10월 업데이트의 세 번째 변경 내용 집합.</span><span class="sxs-lookup"><span data-stu-id="9c66a-143">Third set of changes in an optional October 2019 update, delivered with the November 2019 security update.</span></span>

  > [!NOTE]
  > <span data-ttu-id="9c66a-144">이 업데이트에서는 Microsoft Edge가 더 이상 전자책을 지원하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-144">This is the update where Microsoft Edge will no longer support eBooks.</span></span>

<span data-ttu-id="9c66a-145">다음 표에서는 각 변경 내용 집합의 특정 업데이트에 대한 세부 정보를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="9c66a-145">The following table gives the details for specific updates in each set of changes.</span></span>

| <span data-ttu-id="9c66a-146">Windows 10</span><span class="sxs-lookup"><span data-stu-id="9c66a-146">Windows 10</span></span> | <span data-ttu-id="9c66a-147">추가 정보</span><span class="sxs-lookup"><span data-stu-id="9c66a-147">More Information</span></span> | <span data-ttu-id="9c66a-148">필수 다운로드</span><span class="sxs-lookup"><span data-stu-id="9c66a-148">Required Download</span></span> |
|--|--|--|
| <span data-ttu-id="9c66a-149">버전 1709</span><span class="sxs-lookup"><span data-stu-id="9c66a-149">Version 1709</span></span> | [<span data-ttu-id="9c66a-150">KB4525241</span><span class="sxs-lookup"><span data-stu-id="9c66a-150">KB4525241</span></span>](https://support.microsoft.com/help/4525241/windows-10-update-kb4525241) | [<span data-ttu-id="9c66a-151">Windows 10 버전 1709에 대한 누적 업데이트</span><span class="sxs-lookup"><span data-stu-id="9c66a-151">Cumulative Update for Windows 10 Version 1709</span></span>](https://www.catalog.update.microsoft.com/Search.aspx?q=4525241) |
| <span data-ttu-id="9c66a-152">버전 1803</span><span class="sxs-lookup"><span data-stu-id="9c66a-152">Version 1803</span></span>  | [<span data-ttu-id="9c66a-153">KB4525237</span><span class="sxs-lookup"><span data-stu-id="9c66a-153">KB4525237</span></span>](https://support.microsoft.com/help/4525237/windows-10-update-kb4525237) | [<span data-ttu-id="9c66a-154">Windows 10 버전 1803에 대한 누적 업데이트</span><span class="sxs-lookup"><span data-stu-id="9c66a-154">Cumulative Update for Windows 10 Version 1803</span></span>](https://www.catalog.update.microsoft.com/Search.aspx?q=KB4525237) |
