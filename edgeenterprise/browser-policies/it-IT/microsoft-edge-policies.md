...
|[캐스트](#cast)|[Estensioni](#estensioni)|
...
|[Stampa](#stampa)|[추가 정보](#additional)|
...
|Nome criteri|Sottotitolo|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|Seleziona automaticamente i certificati client per questi siti|
...
|[WebUsbAskForUrl](#webusbaskforurls)|Consenti WebUSB per siti specifici|
