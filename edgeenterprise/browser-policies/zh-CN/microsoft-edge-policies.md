...
|[扩展](#扩展)|[本机消息](#本机消息)|
|[默认的搜索提供程序](#默认的搜索提供程序)|[추가 정보](#additional)|
...
|策略名称|描述|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|自动为这些站点选择客户端证书|
...
|[WebUsbAskForUrl](#webusbaskforurls)|在特定站点上允许 WebUSB|
