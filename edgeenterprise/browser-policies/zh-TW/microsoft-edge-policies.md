...
|[預設搜尋提供者](#預設搜尋提供者)|[추가 정보](#additional)|
...
|原則名稱|標題|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|自動選取這些網站的用戶端憑證|
...
|[WebUsbAskForUrl](#webusbaskforurls)|在特定站台上允許 WebUSB|
