...
|||
|-|-|
|[Application Guard 설정](#application-guard-설정)|[캐스트](#cast)|
...
|정책 이름|설명|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|이 사이트에 대한 클라이언트 인증서 자동 선택|
