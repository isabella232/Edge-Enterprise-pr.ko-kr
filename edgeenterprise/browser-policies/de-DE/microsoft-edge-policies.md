...
|||
|-|-|
|[Application Guard-Einstellungen](#application-guard-einstellungen)|[캐스트](#cast)|
...
|[Start, Startseite und neue Tabseite](#start-startseite-und-neue-tabseite)|[추가 정보](#additional)|
...
|Richtlinienname|Beschriftung|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|Clientzertifikate für diese Websites automatisch auswählen|
...
|[WebUsbAskForUrl](#webusbaskforurls)|WebUSB auf bestimmten Websites zulassen|
