...
|[캐스트](#cast)|[Configuración de Protección de aplicaciones](#configuración-de-protección-de-aplicaciones)|
...
|[Servidor proxy](#servidor-proxy)|[추가 정보](#additional)|
...
|Nombre de directiva|Título|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|Seleccionar automáticamente certificados de cliente para estos sitios|
...
|[WebUsbAskForUrl](#webusbaskforurls)|Permitir WebUSB en sitios específicos|
