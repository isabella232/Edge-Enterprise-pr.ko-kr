...
|||
|-|-|
|[Autenticação HTTP](#autenticação-http)|[캐스트](#cast)|
...
|Nome da Política|Legenda|
|-|-|
|[Autoselectcertificateurl](#autoselectcertificateforurls)|Selecionar automaticamente os certificados de cliente para estes sites|
...
|[WebUsbAskForUrl](#webusbaskforurls)|Permitir WebUSB em sites específicos|
