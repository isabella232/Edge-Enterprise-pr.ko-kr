...
ms.locfileid: "12505471"
---
# <a name="a-detailed-guide-to-configuring-extensions-using-the-extensionsettings-policy"></a>ExtensionSettings 정책을 사용하여 확장을 구성하는 자세한 가이드
...
ExtensionSettings 정책에서 모든 확장 관리 설정을 지정할지 또는 다른 정책을 통해 이러한 컨트롤을 설정할지 결정합니다.
...
이 정책은 초기 설치를 위해 확장을 다운로드할 업데이트 URL 및 차단된 권한과 같은 설정을 제어할 수 있습니다. 이 정책을 사용하여 실행할 수 없는 권한을 식별할 수도 있습니다. 사용 가능한 정책 필드는 다음 표에 설명되어 있습니다.
