...
ms.locfileid: "12297626"
---
# <a name="overview-of-the-microsoft-edge-channels"></a>Microsoft Edge 채널의 개요입니다.

다음 버전의 Microsoft Edge 이점 중 하나는 Microsoft에서 정기적으로 새 기능을 제공할 수 있는 것입니다. 그러나 조직의 사용자에게 Microsoft Edge 배포하는 관리자는 사용자가 이러한 새 기능을 사용할 수 있는 자주 제어해야 할 수 있습니다. Microsoft는 새로운 기능으로 업데이트되는 Microsoft Edge 채널이라는 네 가지 옵션을 제공합니다. 네 가지 옵션에 대한 개요는 다음과 같습니다.

각 채널에 대한 지원에 대한 자세한 내용은 다음을 Microsoft Edge [읽어 보세요.](/deployedge/microsoft-edge-support-lifecycle)
...
배포하기로 결정한 업데이트 채널은 몇 가지 요인에 따라 결정됩니다. 예를 들어 사용 중인 기간 업무(기간 업무) 응용 프로그램의 수는 업데이트가 진행될 때마다 테스트 요구 사항에 Microsoft Edge 있습니다. 이러한 결정을 내리는 데 도움이 되도록 Microsoft Edge에 사용할 수 있는 네 가지 업데이트 채널에 대한 다음 정보를 검토하세요.

### <a name="stable-channel"></a>안정 채널

안정 채널은 조직에서 광범위한 배포를 위한 것이고 대부분의 사용자가 배치해야 하는 채널입니다. 이는 채널 중 가장 안정적인 채널이며 이전 베타 채널 릴리스에서 사용할 수 있는 기능 집합의 안정화 결과입니다. 새로운 기능은 4주마다 제공됩니다. 필요한 경우 보안 및 품질 업데이트가 제공됩니다. 안정 채널의 릴리스는 채널에서 다음 릴리스를 사용할 수 있을 때까지 서비스됩니다.

### <a name="beta-channel"></a>Beta 채널

베타 채널은 대표적인 사용자 샘플 집합에 프로덕션 배포를 위한 것입니다. 지원되는 릴리스이며 베타의 각 릴리스는 다음 릴리스가 제공될 때까지 서비스됩니다. 이 채널은 환경에서 예상대로 작동하고 있는지 확인할 수 있는 좋은 기회를 제공합니다. 문제가 발견된 경우 릴리스가 안정 채널에 게시되기 전에 수정될 수 있습니다. 새로운 기능은 4주마다 제공됩니다. 필요한 경우 보안 및 품질 업데이트가 제공됩니다.

### <a name="dev-channel"></a>Dev 채널

Dev 채널은 Microsoft Edge의 최신 기능을 사용하여 계획하고 개발하는 데 도움을 주기 위해 Canary 채널보다 높은 품질을 제공합니다. 이 채널은 다음에 출시될 버전을 초기에 살펴보고 다음 베타 릴리스를 준비할 수 있는 기회입니다.

### <a name="canary-channel"></a>Canary 채널

Canary 채널은 매일 제공되며 모든 채널의 최첨단에 위치합니다. 새 투자에 액세스하려는 경우 여기에 먼저 표시됩니다. 이 케이던스의 특성 때문에 시간이 지날 때 문제가 발생합니다. Canary 릴리스를 사용하는 경우 다른 채널을 나란히 설치할 수 있습니다.

### <a name="extended-stable-channel"></a>확장 안정 채널

미리 보기 채널(Canary, Dev 및 Beta)과 달리 확장된 안정 채널은 별도의 브라우저 응용 프로그램으로 사용할 수 없습니다. 이 채널은 8주간의 주 릴리스 주기에 맞춰진 Microsoft Edge 안정된 응용 프로그램의 엔터프라이즈 릴리스 옵션입니다. 안정 채널의 4주 주 릴리스 주기와는 반대입니다. 4주 릴리스 주기에 안정을 업데이트하는 것이 권장되는 반면 확장 안정은 새 브라우저 버전을 테스트하고 유효성을 검사하는 데 더 긴 일정이 필요할 수 있는 조직에 보다 효과적으로 서비스를 제공하기 위해 존재합니다.

Microsoft Edge Stable에 대한 8주 "확장된 안정" 릴리스 옵션은 Microsoft Edge 94부터 조차도 번호가 매기기 릴리스에 맞게 누적된 기능 업데이트를 제공합니다. __ 홀수 릴리스의 기능 업데이트는 후속 even-numbered 릴리스의 일부로 패키지 및 전달됩니다. 예를 들어 조직에서 Microsoft Edge 94와 함께 8주 "확장된 안정" 릴리스 주기를 선택하는 경우 Microsoft Edge 96, Microsoft Edge 98과 같은 후속 기능 업데이트를 받을 수 있습니다. 기능 업데이트는 선택한 릴리스 주기에 따라 패키지 및 새 버전 릴리스와 함께 제공되는 반면, 중요한 보안 패치 및 수정은 브라우저 보안을 유지하기 위해 선택한 릴리스 옵션과는 독립적으로 필요한 경우 제공됩니다. 고객은 수시로 확장 안정 릴리스 옵션에 옵트인할 수 있으며 다음 확장 안정 릴리스에 적용됩니다.

![안정 및 확장 Microsoft Edge 주기 옵션을 비교하는 예제입니다.](./media/microsoft-edge-channels/extended-stable-explainer.png)

#### <a name="opting-in-to-the-extended-stable-release-cadence"></a>확장 안정 릴리스 케이던스에 옵트인
...
현재 설치된 디바이스보다 버전 번호가 높은 확장 안정 채널에 대한 다음 업데이트가 릴리스되면 Microsoft Edge 채널로 자동으로 업데이트됩니다. 버전 문자열이 `edge://settings/help` 으로 표시될 경우 다른 채널을 실행 중입니다.
...
Microsoft Edge 관리 템플릿은 관리 센터의 로컬 그룹 정책 개체와 Microsoft Endpoint Manager 있습니다. [Intune을 통해 사용자 Microsoft Edge 가이드를 따르세요.](/mem/intune/configuration/administrative-templates-configure-edge) 
